...
public class SmallJavaTypeConformance {
  ...
  public boolean isConformant(final SJClass c1, final SJClass c2) {
    ...
    if (_equals) {
      ...
      _or_3 = (_equals || _conformToLibraryTypes);
    }
    if (_or_3) {
      _or_2 = true;
    } else {
  ...
  public boolean conformToLibraryTypes(final SJClass c1, final SJClass c2) {
    ...
    if (!_conformsToString) {
      ...
      _and = (_conformsToString && _conformsToString_1);
    }
    if (_and) {
      _or_1 = true;
    } else {
      ...
      if (!_conformsToInt) {
        ...
        _and_1 = (_conformsToInt && _conformsToInt_1);
      }
      _or_1 = (_and || _and_1);
    }
    if (_or_1) {
      ...
      if (!_conformsToBoolean) {
        ...
        _and_2 = (_conformsToBoolean && _conformsToBoolean_1);
      }
      _or = (_or_1 || _and_2);
    }
    return _or;
