...
public class EntitiesCompilerTest {
  ...
  public void testAttributeGeneratedCode() {
    try {
      ...
      _builder_1.newLine();
      _builder_1.append("  ");
      _builder_1.append("private MyEntity e = new Function0<MyEntity>() {");
      _builder_1.newLine();
      _builder_1.append("    ");
      _builder_1.append("public MyEntity apply() {");
      _builder_1.newLine();
      _builder_1.append("      ");
      _builder_1.append("MyEntity _myEntity = new MyEntity();");
      _builder_1.newLine();
      _builder_1.append("      ");
      _builder_1.append("return _myEntity;");
      _builder_1.newLine();
      _builder_1.append("    ");
      _builder_1.append("}");
      _builder_1.newLine();
  ...
  public void testOperationGeneratedCode() {
    try {
      ...
      _builder_1.newLine();
      _builder_1.append("    ");
      _builder_1.append("boolean _add = this.add(s);");
      _builder_1.newLine();
      _builder_1.append("    ");
      _builder_1.append("return _add;");
      _builder_1.newLine();
      _builder_1.append("  ");
      _builder_1.append("}");
      _builder_1.newLine();
