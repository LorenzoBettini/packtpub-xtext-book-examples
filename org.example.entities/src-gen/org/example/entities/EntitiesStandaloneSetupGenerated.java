...
public class EntitiesStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new org.example.entities.EntitiesRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.example.org/entities/Entities")) {
		EPackage.Registry.INSTANCE.put("http://www.example.org/entities/Entities", org.example.entities.entities.EntitiesPackage.eINSTANCE);
	}
