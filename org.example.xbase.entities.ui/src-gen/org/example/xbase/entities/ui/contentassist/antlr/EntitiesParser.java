...
* generated by Xtext
*/
package org.example.xbase.entities.ui.contentassist.antlr;
...
public class EntitiesParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.example.xbase.entities.ui.contentassist.antlr.internal.InternalEntitiesParser createParser() {
		org.example.xbase.entities.ui.contentassist.antlr.internal.InternalEntitiesParser result = new org.example.xbase.entities.ui.contentassist.antlr.internal.InternalEntitiesParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getEntityAccess().getOperationsAssignment_5(), "rule__Entity__OperationsAssignment_5");
					...
					put(grammarAccess.getAttributeAccess().getInitexpressionAssignment_3_1(), "rule__Attribute__InitexpressionAssignment_3_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.example.xbase.entities.ui.contentassist.antlr.internal.InternalEntitiesParser typedParser = (org.example.xbase.entities.ui.contentassist.antlr.internal.InternalEntitiesParser) parser;
