package org.example.xbase.entities.serializer;
...
public class EntitiesSemanticSequencer extends XbaseSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == EntitiesPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case EntitiesPackage.OPERATION:
	...
	/**
	 * Constraint:
	 *     (type=JvmTypeReference? name=ID initexpression=XExpression?)
	 */
	...
	/**
	 * Constraint:
	 *     (name=ID superType=JvmParameterizedTypeReference? attributes+=Attribute* operations+=Operation*)
	 */
