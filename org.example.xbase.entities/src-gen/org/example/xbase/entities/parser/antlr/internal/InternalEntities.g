...
(
		{ 
	        newCompositeNode(grammarAccess.getEntityAccess().getOperationsOperationParserRuleCall_5_0()); 
	    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getAttributeAccess().getTypeJvmTypeReferenceParserRuleCall_1_0()); 
	    }
...
(
    ...
    {
    	newLeafNode(otherlv_3, grammarAccess.getAttributeAccess().getEqualsSignKeyword_3_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getAttributeAccess().getInitexpressionXExpressionParserRuleCall_3_1_0()); 
	    }
		lv_initexpression_4_0=ruleXExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getAttributeRule());
	        }
       		set(
    ...
    {
    	newLeafNode(otherlv_5, grammarAccess.getAttributeAccess().getSemicolonKeyword_4());
    }
)
;
...
(
		{ 
	        newCompositeNode(grammarAccess.getOperationAccess().getTypeJvmTypeReferenceParserRuleCall_1_0()); 
	    }
		lv_type_1_0=ruleJvmTypeReference		{
	        if ($current==null) {
